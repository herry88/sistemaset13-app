...
@section('title', 'Tambah Aset - Sistem Aset')

@section('content')
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Master Data / Aset /</span> Tambah
    </h4>
        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0">
                <div class="card-header d-flex justify-content-between align-items-center bg-white py-3">
                    ...
                    <small class="text-muted float-end font-monospace">{{ $new_code ?? 'Auto' }}</small>
                </div>
                <div class="card-body">
                    <form action="{{ route('aset.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="kode_aset">Kode Aset <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('kode_aset') is-invalid @enderror"
                                    id="kode_aset" name="kode_aset" placeholder="Contoh: AST-001"
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="nama_aset">Nama Aset <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('nama_aset') is-invalid @enderror"
                                    id="nama_aset" name="nama_aset" placeholder="Nama Aset" value="{{ old('nama_aset') }}"
                                    required />
                                @error('nama_aset')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="kategori_id">Kategori <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('kondisi') is-invalid @enderror" id="kondisi"
                                    ...
                                    <option value="Perlu Perbaikan"
                                        {{ old('kondisi') == 'Perlu Perbaikan' ? 'selected' : '' }}>Perlu Perbaikan
                                    </option>
                                </select>
                                @error('kondisi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('jumlah') is-invalid @enderror"
                                    id="jumlah" name="jumlah" placeholder="0" value="{{ old('jumlah', 1) }}"
                                    min="0" required />
                                @error('jumlah')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
