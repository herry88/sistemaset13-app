...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master Data / Mutasi Aset /</span> Edit</h4>

    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Form Edit Mutasi Aset</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('mutasi_aset.update', $mutasiAset->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="aset_id" id="aset_id" class="form-select @error('aset_id') is-invalid @enderror"
                                required>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="lokasi_asal_id" id="lokasi_asal_id"
                                class="form-select @error('lokasi_asal_id') is-invalid @enderror" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="lokasi_tujuan_id" id="lokasi_tujuan_id"
                                class="form-select @error('lokasi_tujuan_id') is-invalid @enderror" required>
