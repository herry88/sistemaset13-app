...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">Menu / Laporan /</span> Lokasi Aset
</h4>
...
<div class="card">
    ...
    <div class="card-body">
        <form method="GET" action="{{ route('laporan.lokasi-aset') }}" class="row g-3">
            <div class="col-md-4">
            ...
            <div class="col-md-4 d-flex align-items-end gap-2">
                ...
                <a href="{{ route('laporan.lokasi-aset') }}" class="btn btn-secondary"><i class="bx bx-refresh"></i> Reset</a>
            </div>
        </form>
    </div>
</div>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Laporan Lokasi Aset</h5>
        <div class="btn-group">
            <a href="{{ route('laporan.export-lokasi-aset', request()->all()) }}" class="btn btn-success btn-sm">
            ...
            <table class="table table-hover">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th class="text-end"><span class="badge bg-success">{{ $lokasi->sum('asets_count') }}</span></th>
                    </tr>
                </tfoot>
            </table>
        </div>
